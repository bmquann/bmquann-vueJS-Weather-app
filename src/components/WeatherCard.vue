<template>
    <router-link tag="section" :to="`/detail/${currentCity}`" class="weather__card">
        <span class="city-name__text">{{currentCity}}</span>
...
export default {
    ...
    methods: {
        getCurrentConditionByName: function () {
            let vm = this;
            let url = 'http://api.openweathermap.org/data/2.5/' + 'weather?q=' + this.currentCity + '&units=metric&appid=' + '9f30480b83ce8cfc3d25b74303ef51fe';
            axios.get(url)
                .then(response => {
